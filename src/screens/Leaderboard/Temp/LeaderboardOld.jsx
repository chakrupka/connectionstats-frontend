...
// import TextScaler from "../../../components/TextScaler.jsx";
...
//               {topGames.topToday ? (
//                 topGames.topToday[1] ? (
//                   <TextScaler text={topGames.topToday[1].user.username} />
//                 ) : (
//                   ""
//                 )
//               ) : (
...
//               )}
//             </div>
//             <div className="lbPodium second">🥈</div>
//           </div>
//           <div className="lbPodiumSection">
//             {topGames.topToday ? (
//               topGames.topToday[0] ? (
//                 <TextScaler text={topGames.topToday[0].user.username} />
//               ) : (
//                 <span>&nbsp;</span>
//               )
//             ) : (
//               "Loading..."
//             )}
//             <div className="lbPodium first">🥇</div>
//           </div>
//           <div className="lbPodiumSection">
//             <div className="lbPodiumName">
//               {topGames.topToday ? (
//                 topGames.topToday[2] ? (
//                   <TextScaler text={topGames.topToday[2].user.username} />
//                 ) : (
//                   ""
//                 )
//               ) : (
...
//               )}
//             </div>
//             <div className="lbPodium third">🥉</div>
//           </div>
//         </div>
